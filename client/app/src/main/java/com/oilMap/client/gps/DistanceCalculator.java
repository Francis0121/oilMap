...
public class DistanceCalculator {
    ...
    public static double distance(Location beforeLocation, Location currentLocation) {
        double P1_latitude = beforeLocation.getLatitude();
        double P1_longitude = beforeLocation.getLongitude();
        double P2_latitude = currentLocation.getLatitude();
        double P2_longitude = currentLocation.getLongitude();
